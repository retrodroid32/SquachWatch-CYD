...
//
// Fixed self-test vector for this fork's OTA key. HASH is SHA-256 of
// "SquachWatch fork OTA signing self-test v1\n"; SIG was made by the matching
// private key. Nothing here reads a site or secret at runtime. A good vector
// must pass and anything modified afterwards must fail. SIGTEST on the console.
const char* testSignature() {
    static const uint8_t HASH[32] = {
        0x91, 0x03, 0xC6, 0x68, 0x16, 0x74, 0xC5, 0x17, 0xA6, 0xC1, 0x69, 0x97,
        0xE7, 0x95, 0xDC, 0x66, 0x16, 0x0B, 0x34, 0x77, 0x39, 0x13, 0x64, 0xD7,
        0xE7, 0x09, 0x5E, 0x61, 0xF9, 0x57, 0x84, 0x2A
    };
    static const uint8_t SIG[71] = {
        0x30, 0x45, 0x02, 0x20, 0x74, 0x4B, 0xBB, 0xEC, 0xFC, 0xCF, 0x18, 0x27,
        0x36, 0xD2, 0x65, 0x8F, 0xC9, 0x0E, 0x6B, 0x34, 0x38, 0x9D, 0xCC, 0x89,
        0x64, 0x4C, 0x1E, 0xE8, 0xA3, 0xA3, 0x4D, 0x78, 0x5F, 0x74, 0xB0, 0x90,
        0x02, 0x21, 0x00, 0xF2, 0xDB, 0x9F, 0x61, 0x7C, 0xA2, 0x31, 0x96, 0xD4,
        0x21, 0x0C, 0x36, 0xC2, 0x87, 0xA8, 0x5C, 0x13, 0xF6, 0xA4, 0xE0, 0xBD,
        0xB5, 0x55, 0x85, 0xE1, 0xC3, 0x08, 0x54, 0x84, 0xE6, 0xED, 0x46
    };
