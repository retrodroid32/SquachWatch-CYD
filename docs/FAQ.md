...
No. That's what the [web flasher](https://retrodroid32.github.io/SquachWatch-CYD/) is for — plug your board into a computer running Chrome, Edge, Brave, or another Chromium browser with Web Serial, hit Connect & Install, and the firmware goes straight from your browser onto the board. No compiler, no IDE, no me judging your PlatformIO setup (I would never. probably).
